...
export declare const PROBLEM_CODES: readonly ["missing-section", "unknown-section", "section-out-of-order", "empty-required-section", "missing-block", "too-many-blocks", "disallowed-block", "prototype-below-minimum", "unresolved-finding"];
