import type { Approval, PlanDocument, PlanKind, PlanMeta, PlanStatus } from "@re-cinq/planning-document";
export declare const VERSION_REASONS: readonly ["publish", "approval", "agent-write", "restore", "auto"];
