...
export const KPI_DIRECTIONS = ["up", "down", "hold"];
...
export const MOCKUP_FORMATS = ["svg", "mermaid", "html"];
export const QUESTION_KINDS = ["text", "choice"];
export const FINDING_SEVERITIES = ["blocker", "warning"];
...
export const PLAN_BLOCK_KINDS = Object.keys(PLAN_BLOCK_CONFIGS);
//# sourceMappingURL=plan-block-configs.js.map