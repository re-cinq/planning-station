...
export declare const MARKDOWN_PROBLEM_CODES: readonly ["unknown-section", "duplicate-section", "renamed-template-section", "untitled-section", "invalid-fence", "disallowed-block"];
...
export declare function changed(...ops: AgentOp[]): MarkdownOps;
