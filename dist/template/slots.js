...
export const MARGIN_NOTES = ["comment", "section-panel"];
...
export function allowsBlock(slot, type) {
    return (slot.allows.includes(type) ||
        ALWAYS_ALLOWED.includes(type));
}
export function disallowedBlockMessage(slot, type) {
