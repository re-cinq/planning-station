...
- One pass proposes for the section a person asked about and for every other section its settled answers forced, each against that section as it stands, so every change is reviewed where it lands ([validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L191)).
- A section whose proposal someone is already reviewing is left alone by a later pass, and reported as skipped rather than replaced; a section whose refine failed is not being reviewed, so a later pass proposes for it ([validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L230), [validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L237)).
...
- When the agent could not answer, the ask turns failed with the reason, keeping who asked, when, and the section hash it was asked against ([validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L251)).
- A failure that arrives after the agent's proposal leaves the proposal alone, and a failure for a section nobody asked about writes nothing; either way the caller is told what the section holds ([validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L268), [validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L278)).
- Asking again replaces a failed refine with a fresh ask ([validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L287)).
