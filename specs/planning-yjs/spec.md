...
- A person's ask and the agent's proposal live in the document beside the plan's blocks, so every client sees them and the plan itself stays unchanged until someone accepts ([validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L72), [validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L79)).
- One pass proposes for the section a person asked about and for every other section its settled answers forced, each against that section as it stands, so every change is reviewed where it lands ([validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L168)).
- A section whose proposal someone is already reviewing is left alone by a later pass, and reported as skipped rather than replaced; a section whose refine failed is not being reviewed, so a later pass proposes for it ([validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L207), [validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L214)).
- A proposal that reaches outside its section is refused with ProposalScopeError ([validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L92)).
- Accepting writes the proposal into its section, marks the inputs it used, and clears it; discarding clears it and leaves the section alone ([validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L105), [validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L114), [validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L146)).
- A proposal can be applied anyway, running its ops onto the section as it stands, so what was written meanwhile survives beside it ([validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L130)).
- A proposal whose section changed after the ask is refused with SectionChangedError, and one the agent has not answered yet — or could not answer — with NoProposalError ([validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L122), [validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L155), [validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L274)).
- When the agent could not answer, the ask turns failed with the reason, keeping who asked, when, and the section hash it was asked against ([validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L228)).
- A failure that arrives after the agent's proposal leaves the proposal alone, and a failure for a section nobody asked about writes nothing; either way the caller is told what the section holds ([validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L245), [validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L255)).
- Asking again replaces a failed refine with a fresh ask ([validated by](../../packages/planning-yjs/src/refine/proposals.test.ts#L264)).
